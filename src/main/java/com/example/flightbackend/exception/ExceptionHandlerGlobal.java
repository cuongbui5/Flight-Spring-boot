...
public class ExceptionHandlerGlobal {
    ...
    public ResponseEntity<?> handlerRuntimeException(RuntimeException e){
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(
                new MessageResponse("fail",e.getMessage())
        );
    }
    ...
    public ResponseEntity<?> handleBindException(
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(new MessageResponse("fail",errors.toString()));
    }
    ...
    public ResponseEntity<?> handlerMethodArgumentNotValidException(MethodArgumentNotValidException e){
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(
                new MessageResponse("fail", specificErrorMessage)
        );
    }
    ...
    public ResponseEntity<?> handlerWrongUsernameOrEmail(WrongUsername e){
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(
                new MessageResponse("fail", e.getMessage())
        );
    }
